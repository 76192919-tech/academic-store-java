...
|---|---|---|---|
| Fabricio Santos Rivas | 76192919@mail.isil.pe | Jerarquía de clases (Producto, subclases, interfaz) | 25% |
...
|---|---|---|
| Integrante 1 (Fabricio Santos Rivas) | Jerarquía de clases | Diseño e implementación de `Producto` (clase abstracta), `ProductoFisico`, `ProductoDigital` y la interfaz `Descontable`, incluyendo la sobrescritura de `mostrarInfo()` en cada subclase. |
